            ...
            <div style="width: 80%;margin:10px auto;">
                ...
                <div style="width: 50%;float: left;text-align: left;">
                    ...
                    <label>Thanks for sign up! We just need you verify your email address to complete setting up your
                        account</label>
                    <!--  -->
                    <a href='${process.env.HOST}:${process.env.SERVER_PORT}/graphql/?query={verifyEmail(secretKey: "${urlEndPoint}"){status}}' style="text-decoration: unset;"><input type="button" style="display: block; margin-top: 50px;font-family: 'Latos' !important;    padding: 8px;
